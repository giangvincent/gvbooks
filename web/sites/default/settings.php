 ...
 * @endcode
 */
$settings['hash_salt'] = 'PMt1Fznb1J2A5mbxVTYQ8jgNXhvwW5tr_nRXHNV16ZJhlY1eAkqoL-09_c2EGXeWJmsNxKKEUw';
...
if (getenv('IS_DDEV_PROJECT') === 'true' && file_exists($app_root . '/' . $site_path . '/settings.ddev.php')) {
  ...
  $databases['default']['default'] = array (
    'database' => '/Users/giangvincent/Documents/drupal/GvBooks/web/core/sites/default/files/.ht.sqlite',
    'prefix' => '',
    'driver' => 'sqlite',
...
$settings['config_sync_directory'] = 'sites/default/files/config_egWEZhp8cFwUo08TgxeEx8dBLxdsiK8s4cBrIZnYVSs8Thohtu4IavMYYOsZhLlsehEDNEj0rQ/sync';
